...
%\VignetteIndexEntry{the homework 3}
-->
## Question 1 - Pg117.7 
```{r}
...
$$
Therefore, $f(x) = x^2$ is convex, and we now that the following sum of squares of convex is also convex as well.
$$
...
summary(outcome)
```
According to the summary of the outcome, there are 3997 of False and only 3 True, hence we can conluse that there are limited KTT violation here. Lasso screening is generally a well fit. 
